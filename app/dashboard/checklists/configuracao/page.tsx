...
export default function ConfiguracaoChecklistPage() {
  ...
  return <div className="space-y-6 p-6 lg:p-8">
    ...
    <div className="grid gap-4 sm:grid-cols-3">{[
      ...
      ["Ativos", itens.filter((item) => item.ativo).length, "bg-emerald-500/10 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-400"],
      ["Específicos por módulo", itens.filter((item) => item.ativo && item.modulo).length, "bg-blue-500/10 text-blue-600 dark:bg-blue-500/15 dark:text-blue-400"],
